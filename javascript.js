...
var saying = document.querySelector('.quote')
...
var randomNumber = Math.random() * api.length

const n = Math.round(randomNumber)

console.log(n)

for (const quotes of api) {
    var quote = api[n]
    saying.innerHTML = quote.text  
    var theauthor = quote.author
    var polishedAuthor = theauthor.replace('type.fit','')
    
    author.innerHTML = '-' + polishedAuthor.replace(',','')
    console.log(api[0])
break
